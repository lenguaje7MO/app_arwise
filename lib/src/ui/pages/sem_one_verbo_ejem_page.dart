...
class SemOneVerboEjemPage extends StatefulWidget {
  const SemOneVerboEjemPage();

  @override
  State<SemOneVerboEjemPage> createState() => _SemOneVerboEjemPageState();
}

class _SemOneVerboEjemPageState extends State<SemOneVerboEjemPage> {
              ...
              children: [
               ...
               const Card(
                ...
                SizedBox(
                  ...
                  child: Image.asset('assets/img/logos/img_verbos_ej.png'),
                ),
              ],
            ),
          ),
