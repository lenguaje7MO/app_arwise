...
class SemOneDiptongoEjemPage extends StatefulWidget {
  const SemOneDiptongoEjemPage();

  @override
  State<SemOneDiptongoEjemPage> createState() => _SemOneDiptongoEjemPageState();
}

class _SemOneDiptongoEjemPageState extends State<SemOneDiptongoEjemPage> {
